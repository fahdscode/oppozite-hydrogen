        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/oppozite.eg?igsh=aG40MDZhNTZobWdn&utm_source=qr" target="_blank" rel="noopener noreferrer" className="p-2 border border-background/30 hover:bg-background hover:text-foreground transition-colors text-background">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.facebook.com/share/1ZtnxAUmdd/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="p-2 border border-background/30 hover:bg-background hover:text-foreground transition-colors text-background">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.tiktok.com/@oppozite.eg?_r=1&_t=ZS-928atypcjH0" target="_blank" rel="noopener noreferrer" className="p-2 border border-background/30 hover:bg-background hover:text-foreground transition-colors text-background">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
